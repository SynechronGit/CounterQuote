...
SWIFT_MODULE_NAMESPACE_PUSH("ATKit")
@class NSCoder;
...
@interface ATDrawer : NSObject <UITableViewDataSource, UITableViewDelegate>
...
+ (ATDrawer * _Nonnull)sharedInstance SWIFT_WARN_UNUSED_RESULT;
...
@interface ATDropdownMenu : NSObject <UITableViewDataSource, UITableViewDelegate>
@property (nonatomic, copy) NSArray<ATDropdownOption *> * _Null_unspecified options;
@property (nonatomic, copy) NSArray<ATDropdownOption *> * _Null_unspecified selectedOptions;
@property (nonatomic) BOOL allowMultipleSelection;
...
+ (ATDropdownMenu * _Nonnull)sharedInstance SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
- (void)show;
- (void)hide;
- (NSInteger)tableView:(UITableView * _Nonnull)tableView numberOfRowsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
...
@interface ATFilePicker : NSObject <UIActionSheetDelegate, UIDocumentPickerDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate>
...
@interface ATImagePicker : NSObject <UIActionSheetDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate>
...
+ (ATOverlay * _Nonnull)sharedInstance SWIFT_WARN_UNUSED_RESULT;
- (void)show;
...
@interface ATTextField : UITextField <UITableViewDataSource, UITableViewDelegate, UITextFieldDelegate>
...
- (BOOL)atTextField:(UITextField * _Nonnull)textField shouldChangeCharactersInRange:(NSRange)range replacementString:(NSString * _Nonnull)string SWIFT_WARN_UNUSED_RESULT;
...
@interface ATTextView : UITextView <UITextViewDelegate>
@property (nonatomic, copy) NSCharacterSet * _Null_unspecified allowedCharacterSet;
...
- (BOOL)atTextView:(UITextView * _Nonnull)textView shouldChangeTextInRange:(NSRange)range replacementText:(NSString * _Nonnull)string SWIFT_WARN_UNUSED_RESULT;
...
+ (float)degreesToRadians:(float)pDegrees SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
+ (UIImage * _Null_unspecified)animatedImageWithGifDataWithData:(NSData * _Nonnull)pData SWIFT_WARN_UNUSED_RESULT;
...
- (UIView * _Nullable)viewWithRestorationIdentifier:(NSString * _Nonnull)pRestorationIdentifier SWIFT_WARN_UNUSED_RESULT;
@end
