...
class VideoCallViewController: UIViewController {
    ...
    var tokenUrl = "https://fair-toes-7372.twil.io/video-token?identity=Agent"
...
//                self.micButton.setImage(UIImage(named: "videoIcon"), for: .normal)
//            } else {
//                self.micButton.setImage(UIImage(named: "noVideoIcon"), for: .normal)
//                
//            }
        }
    }
